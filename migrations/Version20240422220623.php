 ...
 */
final class Version20240422220623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notification_new_course (idnotification INT AUTO_INCREMENT NOT NULL, tutor_notified INT DEFAULT NULL, title VARCHAR(255) NOT NULL, is_checked TINYINT(1) NOT NULL, date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX IDX_1576F2B189843FC4 (tutor_notified), PRIMARY KEY(idnotification)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comments (post INT NOT NULL, owner INT NOT NULL, idComment INT AUTO_INCREMENT NOT NULL, content TEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, attachment VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_general_ci`, INDEX idUser (owner), INDEX idPost (post), PRIMARY KEY(idComment)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
