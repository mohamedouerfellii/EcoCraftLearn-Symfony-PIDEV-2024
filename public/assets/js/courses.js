    ...
    $.ajax({
        ...
        if (courses) {
            ...
            $("#mainAllCourseDiv").empty();
                let courseDetailUrl = "/tutor/tutorCourseDetails";
    ...
    $.ajax({
        ...
        if (courses) {
            ...
            $("#mainDivCourses").empty();
                ...
                $.each(JSON.parse(courses), function (i, obj) {           
                let imageSrc = "../../contents/uploads/courses/" + obj.image;
                let tutorImgSrc = "../../contents/uploads/users/" + obj.tutor['image'];
                let courseUrl = courseDetailUrl + obj.idcourse;
                ...
                let $tutorNameAL = $("<a href='#'>"+ obj.tutor["firstname"] + obj.tutor["lastname"] +"</a>");
                ...
                let $courseRegisteredSpan = $("<span> <i class='icofont-read-book'></i>"+obj.nbrregistred+" Registered</span>");
                ...
                $courseContentDiv.append($courseDurationRegistered);
