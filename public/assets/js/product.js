...
function searchProduct(searchTerm) {
    let url = "/student/searchProducts"; 
    $.ajax({
        type: "GET",
        url: url,
        ...
        success: function (data) {
            if (data) {
                ...
                $.each(data, function (i, obj) {
                    ...
                    let productUrl = "/student/addevaluationproduct/" + obj.idproduct;
                    let buyNowUrl = "/student/buy_now/" + obj.idproduct;
...
function filterProduct(filter) {
    let url = "/student/filterProduct?filter=" + filter; 
    $.ajax({
        type: "GET",
        url: url,
        success: function (data) {
