...
{
    #[Route('/student/submitAnswer/{idCourse}/{sectionIndex}/{idQuiz}/{result}', name: 'submit_answer')]
    public function submitAnswer(Request $request,ManagerRegistry $doctrine)
    {
        ...
        $answer->setStudent($em->getRepository(Users::class)->findOneBy(['email' => $this->getUser()->getUserIdentifier()]));
