...
{
    #[Route('/student/order-product/{idcarts}/{totalPrice}', name: 'OrderProduct')]
    public function confirmOrder(Request $request, int $idcarts, float $totalPrice, ProductsRepository $productsRepository,ManagerRegistry $doctrine): Response
    {
    ...
    #[Route('/student/my-order', name: 'My_Order')]
    public function myOrder(CommandesRepository $rep, ManagerRegistry $doctrine):Response
    {
    ...
    #[Route('/admin/ordersinprogress', name: 'ordersinprogress')]
    ...
    #[Route('/admin/DeleviredOrder/{idcommande}', name: 'DeleviredOrder')]
    ...
    #[Route('/student/Pagepayment/{idCommande}/{total}', name: 'Pagepayment')]
    ...
    #[Route('/student/process-payment', name: 'process_payment')]
