 ...
 */
final class Version20240415153519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quizquestions ADD choice1 VARCHAR(65535) NOT NULL, ADD choice2 VARCHAR(65535) NOT NULL, ADD choice3 VARCHAR(65535) NOT NULL, ADD choice4 VARCHAR(65535) NOT NULL, DROP choice_1, DROP choice_2, DROP choice_3, DROP choice_4, CHANGE quiz quiz INT DEFAULT NULL, CHANGE question question VARCHAR(65535) NOT NULL');
        ...
        $this->addSql('ALTER TABLE users CHANGE isActive isactive TINYINT(1) NOT NULL, CHANGE nbrPtsCollects nbrptscollects INT NOT NULL, CHANGE question question VARCHAR(255) NOT NULL, CHANGE answer answer VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE eventsevaluations (event INT NOT NULL, evaluator INT NOT NULL, idEvaluation INT AUTO_INCREMENT NOT NULL, rate INT NOT NULL, INDEX idUser (evaluator), INDEX idEvent (event), PRIMARY KEY(idEvaluation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE eventsparticipations (event INT NOT NULL, participant INT NOT NULL, idParticipation INT AUTO_INCREMENT NOT NULL, INDEX idUser (participant), INDEX idEvent (event), PRIMARY KEY(idParticipation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE postslikes (post INT NOT NULL, idLike INT AUTO_INCREMENT NOT NULL, idUser INT NOT NULL, action INT DEFAULT 0 NOT NULL, INDEX idUser (idUser), INDEX idPost (post), PRIMARY KEY(idLike)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE productsevaluations (product INT NOT NULL, evaluator INT NOT NULL, idEvaluation INT AUTO_INCREMENT NOT NULL, rate DOUBLE PRECISION NOT NULL, evaluationDate DATE DEFAULT \'current_timestamp()\' NOT NULL, INDEX idUser (evaluator), INDEX idProduct (product), PRIMARY KEY(idEvaluation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE quizquestions ADD choice_1 TEXT NOT NULL, ADD choice_2 TEXT NOT NULL, ADD choice_3 TEXT NOT NULL, ADD choice_4 TEXT NOT NULL, DROP choice1, DROP choice2, DROP choice3, DROP choice4, CHANGE quiz quiz INT NOT NULL, CHANGE question question TEXT NOT NULL');
        ...
        $this->addSql('ALTER TABLE users CHANGE isactive isActive TINYINT(1) DEFAULT 1 NOT NULL, CHANGE nbrptscollects nbrPtsCollects INT DEFAULT 0 NOT NULL, CHANGE question question VARCHAR(255) DEFAULT \'NULL\', CHANGE answer answer VARCHAR(255) DEFAULT \'NULL\'');
