...
class ProductsevaluationsController extends AbstractController
{
    ...
    #[Route('/student/addevaluationproduct/{idproduct}', name: 'addevaluationproduct')]
    ...
    #[Route('/admin/showEvaluationsDashboard', name: 'showEvaluationsDashboard')]
    ...
    #[Route('/student/deleteevaluation/{idevaluation}/{idproduct}', name: "deleteevaluation")]
