...
class CartsController extends AbstractController
{
    ...
    #[Route('/student/buy_now/{idproduct}', name: 'buy_now')]
    public function buyNow($idproduct, EntityManagerInterface $entityManager, Request $request,ManagerRegistry $doctrine): Response
    {
...
if ($quantite === 0) {
    ...
    #[Route('/student/my-cart', name: 'my_cart')]
    public function myCart(CartsRepository $cartsRepository, SouscartsRepository $souscartsRepository, ManagerRegistry $doctrine): Response
    {
        $user = $doctrine->getManager()->getRepository(Users::class)->findOneBy(['email' => $this->getUser()->getUserIdentifier()]);
        if (!$user) {
    ...
    #[Route('/student/deletesoucart/{idSouscarts}', name: "deletesoucart")]
    ...
    #[Route('/student/DeleteCart/{idcarts}', name: "DeleteCart")]
