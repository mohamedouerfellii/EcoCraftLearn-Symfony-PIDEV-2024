...
class EventsparticipationsController extends AbstractController
{
 ...
 #[Route('/student/participate/{idevent}', name: 'participate')]
public function participate(Request $request, ManagerRegistry $doctrine, int $idevent, MailerInterface $mailer): Response 
{
    ...
    #[Route('/student/showMyParticipations', name: 'showMyParticipations')]
...
#[Route('/student/cancelParticipation/{idparticipation}', name: 'cancelParticipation')]
