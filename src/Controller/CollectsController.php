...
{
    #[Route('/student/collects', name: 'app_collects')]
   ...
   #[Route('/student/add_collects', name: 'add_collects')]
...
Request $request,ManagerRegistry $doctrine,SessionInterface $session): Response {
    ...
    return $this->render('collects/frontOffice/frontadd.html.twig', [
        'form' => $form->createView(),
        
    ]);
}

    #[Route('/student/afficher_collects', name: 'afficher_collects')]
    ...
    $Collects = $repo->findAll();
        ...
        return $this->render('collects/frontOffice/index.html.twig' , [
            'Collects' => $pagination ,
            'ajoutA' => $Collects
        ]) ;
    }

    #[Route('/student/delete_adh/{id}', name: 'delete_adh')]
...
#[Route('/student/update_collects/{id}', name: 'update_collects')]
public function update(CollectsRepository $repo, $id, Request $request, ManagerRegistry $doctrine): Response
{
    ...
    return $this->render('collects/frontOffice/update.html.twig', [
        'form' => $form->createView()
    ]);
}

#[Route('/student/generate_pdf', name: 'generate_pdf')]
...
#[Route('/student/searchCollects', name: 'search_Collect_Front')]
