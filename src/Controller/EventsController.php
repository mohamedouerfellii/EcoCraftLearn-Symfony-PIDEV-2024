...
{
    #[Route('/tutor/Add-Event', name: 'AddEvent')]
    ...
    #[Route('/tutor/showEventsDashboardtutor', name: 'showEventsDashboardtutor')]
    public function showAllEventsDashbord(EventsRepository $rep, ManagerRegistry $doctrine): Response
    {

        $user = $doctrine->getManager()->getRepository(Users::class)->findOneBy(['email' => $this->getUser()->getUserIdentifier()]); 
        $userid=$user->getIduser();  
        $events = $rep->findByOwner($userid); 
        return $this->render("events/backOffice/eventDashboardTutor.html.twig", ["Events" => $events]);

    }
    #[Route('/tutor/eventsDetails{idevent}', name: 'eventsDetails')]
    ...
    #[Route('/tutor/deleteEvent{idevent}', name: 'deleteEvent')]
    ...
    #[Route('/tutor/updateEvent{idevent}', name: 'updateEvent')]
    ...
    #[Route('/student/showEvents', name: 'showEvents')]
    ...
    #[Route('/student/eventsDetailsfront/{idevent}', name: 'eventsDetailsfront')]
    ...
    #[Route('/student/searchevents', name: 'search_events_Front')]
    ...
    #[Route('/student/filterEventBydate', name: 'filterEventBydate')]
